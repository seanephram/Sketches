...
#define NUM_LEDS 70                                           // Number of LED's.
...
void ChangeMe() {                                             // A time (rather than loop) based demo sequencer. This gives us full control over the length of each sequence.
  ...
  if (lastSecond != secondHand) {                             // Debounce to make sure we're not repeating an assignment.
    ...
    switch(secondHand) {
      ...
      case  5: numdots = 2; thisbeat = 15; thisdiff = 8; thisfade = 4; thishue = 32; break;  // You can change values here, one at a time , or altogether.
      case 10: numdots = 4; thisbeat = 10; thisdiff = 16; thisfade = 8; thishue = 128; break;
      case 15: numdots = 6; thisbeat = 5;  thisdiff = 8; thisfade = 6; thishue = 64; break;
      ...
      case 25: numdots = 10; thisbeat =  1; thisdiff =  4; thisfade = 16; thishue=random8(); break;
      case 30: break;
    }
  }
